...
public class ItemAdapter extends ArrayAdapter<Item> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Find the TextView in the item.xmlut with the ID miwok_text_view.
        ...
        // Find the TextView in the item.xmlut with the ID default_text_view.
        TextView defaultTextView = (TextView) listItemView.findViewById(R.id.default_text_view);
        // Get the default translation from the currentItem object and set this text on
        // the default TextView.
        defaultTextView.setText(currentItem.getPrice());
